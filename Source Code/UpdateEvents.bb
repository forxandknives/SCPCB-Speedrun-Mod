						...
						For x=0 To 7
							For y=0 To 2
								...
								For n.NPCs = Each NPCs
									...
									EndIf
								Next
								scale# = (Scale14991 / 4) * Rnd(0.8, 1.0) ;(GetINIFloat("DATA\NPCs.ini", "SCP-1499-1", "scale") / 4.0) * Rnd(0.8,1.0)
						...
						If e\EventState=>350 Then
							If Contained106=False Then
								...
								Else
									...
									;AAText GraphicWidth/2, GraphicHeight/2, Str(GameTime), True, True
